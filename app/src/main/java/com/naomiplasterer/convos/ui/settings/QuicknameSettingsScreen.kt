...
@Composable
fun QuicknameSettingsScreen(
    viewModel: QuicknameSettingsViewModel = hiltViewModel(),
    onBackClick: () -> Unit = {}
) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Save your name to quickly add it in new conversations",
            ...
            Column(
                ...
                Button(
                    onClick = { viewModel.saveQuickname() },
                    modifier = Modifier.fillMaxWidth(),
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            title = { Text("Delete Quickname?") },
            text = {
                Text("This will remove your saved name. You can set it up again later.")
            },
            confirmButton = {
                TextButton(
                    onClick = {
                        viewModel.deleteQuickname()
