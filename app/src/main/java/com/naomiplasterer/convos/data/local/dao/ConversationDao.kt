...
interface ConversationDao {
    ...
    @Query("SELECT * FROM conversations WHERE inboxId = :inboxId AND consent = 'allowed' AND isDraft = 0 ORDER BY lastMessageAt DESC")
    fun getAllowedConversations(inboxId: String): Flow<List<ConversationEntity>>
